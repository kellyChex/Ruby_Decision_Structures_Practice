...
# /\s+/ The slashes start and end the pattern. \W means "any non-alphabetic
#character
...
#Exercises
puts "The second through sixth words are #{words.slice(1..6)}"

puts "The first line has #{lines[0].split(/\W+/).length} words in it"

first_stanza_lines = poem.index(/\n\n/)

first_stanza = poem[0,first_stanza_lines]
first_stanza = first_stanza.split(" ")
